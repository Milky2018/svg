...
| --- | ---: | --- | --- | --- | --- |
| [ISS-035](ISS-035.md) | 1 | task | unassigned | Cut over the rendering facade and remove the old rasterizer | renderer, api, cleanup, ci, benchmark, agent |
...
| [ISS-028](ISS-028.md) | in_progress | 1 | epic | codex | ISS-035 | none | Replace the integer SVG renderer |
...
| [ISS-035](ISS-035.md) | open | 1 | task | unassigned | none | ISS-028 | Cut over the rendering facade and remove the old rasterizer |
